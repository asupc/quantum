        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowEnvValues = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunId = table.Column<string>(type: "longtext", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseHash = table.Column<string>(type: "longtext", nullable: true),
                    NewContent = table.Column<string>(type: "longtext", nullable: true),
                    NewHash = table.Column<string>(type: "longtext", nullable: true),
                    Summary = table.Column<string>(type: "longtext", nullable: true),
                    Diagnostics = table.Column<string>(type: "longtext", nullable: true),
                    TestStatus = table.Column<string>(type: "longtext", nullable: true),
                    TestRunLogId = table.Column<string>(type: "longtext", nullable: true),
                    Status = table.Column<string>(type: "varchar(255)", nullable: true),
                    AppliedVersionId = table.Column<string>(type: "longtext", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    AppliedTime = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsePlatformProxy = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    TimeoutSeconds = table.Column<int>(type: "int", nullable: false),
                    MaxRetries = table.Column<int>(type: "int", nullable: false),
                    Enable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Sort = table.Column<int>(type: "int", nullable: false),
                    SupportsTools = table.Column<int>(type: "int", nullable: false),
                    LastTestTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastTestOk = table.Column<bool>(type: "tinyint(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunTimeoutSeconds = table.Column<int>(type: "int", nullable: false),
                    LogTailLines = table.Column<int>(type: "int", nullable: false),
                    AutoAnalyzeOnFailure = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    TestRunNotifyMode = table.Column<string>(type: "longtext", nullable: true),
                    TestRunRequireConfirm = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    KeepVersionsPerFile = table.Column<int>(type: "int", nullable: false),
                    SaveFullPrompt = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SystemPromptExtra = table.Column<string>(type: "longtext", nullable: true),
                    AllowScriptDelete = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AllowTaskManage = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AllowEnvManage = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AllowCustomDataManage = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(64)", nullable: false),
                    RunId = table.Column<string>(type: "varchar(255)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Jump = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskPush = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SystemPush = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SecurityPush = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DndStart = table.Column<string>(type: "longtext", nullable: true),
                    DndEnd = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionKey = table.Column<string>(type: "varchar(255)", nullable: true),
                    Payload = table.Column<string>(type: "longtext", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SessionKey = table.Column<string>(type: "varchar(255)", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Enable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnableRegex = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data1 = table.Column<string>(type: "longtext", nullable: true),
                    Data2 = table.Column<string>(type: "longtext", nullable: true),
                    Data3 = table.Column<string>(type: "longtext", nullable: true),
                    Data4 = table.Column<string>(type: "longtext", nullable: true),
                    Data5 = table.Column<string>(type: "longtext", nullable: true),
                    Data6 = table.Column<string>(type: "longtext", nullable: true),
                    Data7 = table.Column<string>(type: "longtext", nullable: true),
                    Data8 = table.Column<string>(type: "longtext", nullable: true),
                    Data9 = table.Column<string>(type: "longtext", nullable: true),
                    Data10 = table.Column<string>(type: "longtext", nullable: true),
                    Data11 = table.Column<string>(type: "longtext", nullable: true),
                    Data12 = table.Column<string>(type: "longtext", nullable: true),
                    Data13 = table.Column<string>(type: "longtext", nullable: true),
                    Data14 = table.Column<string>(type: "longtext", nullable: true),
                    Data15 = table.Column<string>(type: "longtext", nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title4 = table.Column<string>(type: "longtext", nullable: true),
                    Title5 = table.Column<string>(type: "longtext", nullable: true),
                    Title6 = table.Column<string>(type: "longtext", nullable: true),
                    Title7 = table.Column<string>(type: "longtext", nullable: true),
                    Title8 = table.Column<string>(type: "longtext", nullable: true),
                    Title9 = table.Column<string>(type: "longtext", nullable: true),
                    Title10 = table.Column<string>(type: "longtext", nullable: true),
                    Title11 = table.Column<string>(type: "longtext", nullable: true),
                    Title12 = table.Column<string>(type: "longtext", nullable: true),
                    Title13 = table.Column<string>(type: "longtext", nullable: true),
                    Title14 = table.Column<string>(type: "longtext", nullable: true),
                    Title15 = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogPath = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sort = table.Column<int>(type: "int", nullable: false),
                    HideInMenu = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Title = table.Column<string>(type: "longtext", nullable: true),
                    Icon = table.Column<string>(type: "longtext", nullable: true),
                    HideInBread = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsDefault = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SrciptFile = table.Column<string>(type: "longtext", nullable: true),
                    HttpMethod = table.Column<string>(type: "longtext", nullable: true),
                    Envs = table.Column<string>(type: "longtext", nullable: true),
                    Enable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Whitelist = table.Column<string>(type: "longtext", nullable: true),
                    EnablePush = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnableProxy = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommandEnv = table.Column<string>(type: "longtext", nullable: true),
                    Cron = table.Column<string>(type: "longtext", nullable: true),
                    FileName = table.Column<string>(type: "longtext", nullable: true),
                    TextToPicture = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnableRegex = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Enable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DayLimit = table.Column<int>(type: "int", nullable: false),
                    EnablePush = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    PushGroup = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Revocation = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Manager = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    WaitTime = table.Column<int>(type: "int", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TaskStatus = table.Column<int>(type: "int", nullable: false),
                    TaskThreadId = table.Column<string>(type: "longtext", nullable: true),
                    TaskStartNotify = table.Column<string>(type: "longtext", nullable: true),
                    TaskEndNotify = table.Column<string>(type: "longtext", nullable: true),
                    Remark = table.Column<string>(type: "longtext", nullable: true),
                    CommunicationTypes = table.Column<string>(type: "longtext", nullable: true),
                    EnableProxy = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SessionName = table.Column<string>(type: "varchar(100)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Command = table.Column<string>(type: "longtext", nullable: true),
                    Sort = table.Column<int>(type: "int", nullable: false),
                    TaskId = table.Column<string>(type: "varchar(255)", nullable: true),
                    CommandEnv = table.Column<string>(type: "longtext", nullable: true),
                    Revocation = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    WaitTime = table.Column<int>(type: "int", nullable: false),
                    Remark = table.Column<string>(type: "longtext", nullable: true)
